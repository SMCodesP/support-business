...
// const BoxAnimate = dynamic(() => import("@/components/BoxAnimate"), {
//   ssr: false
// })
    ...
    <div>
      ...
      <DefaultInformation>
        ...
        <ContainerText>
          ...
          <DescriptionInformation>
            ...
            ato de se preparar para algo. A ideia é exatamente essa, evitar ser
            pego de surpresa ou desprevenido. Isso nos leva a analisar quais
            serão os passos que vamos tomar para cuidar das finanças de nossas
            casas ou dos nossos próprios negócios.
          </DescriptionInformation>
          <DescriptionInformation>
        ...
        <ContainerText>
          ...
          <DescriptionInformation>
            ...
            tranquilidade, as suas necessidades cotidianas no curto prazo. dessa
            forma planejamento financeiro pode ser uma maneira de manter um
            equilíbrio entre as necessidades presentes e futuras. No entanto,
            para garantir essa estabilidade é necessário ter bastante vontade e
        ...
        <ContainerText>
          ...
          <DescriptionInformation>
            <ul>
              ...
              <li>
                Planejamento a Curto Prazo: os planos de ação e cronogramas são
                elaborados para que os resultados sejam alcançados de maneira
                mais rápida.
              </li>
            </ul>
          </DescriptionInformation>
      ...
      <DefaultInformation>
        <ContainerText>
          ...
          <DescriptionInformation>
            É um tipo de registro que engloba todas as movimentações financeiras
            realizadas dentro de uma organização. Nesse controle, é realizado
            anotações das entradas e saídas de dinheiro.
          </DescriptionInformation>
      ...
      <DefaultInformation background={theme.purple}>
        ...
        <ContainerText>
          ...
          <DescriptionInformation>
            A Demonstração do Resultado do Exercício (DRE) é um mapa da situação
            da empresa, considerando receita, custos, tributos e lucro.
            Basicamente, essa demonstração subtrai do faturamento os tributos,
            os custos da operação e outras despesas, construindo o resultado
            líquido.
          </DescriptionInformation>
          <TitleInformation>Vantagens</TitleInformation>
          <DescriptionInformation>
            <ul>
              ...
              <li>Gerar benchmark e indicar se há necessidade de melhorar;</li>
              <li>Acompanhar os procedimentos adotados pelos concorrentes;</li>
      ...
      <DefaultInformation>
        <ContainerText>
          ...
          <DescriptionInformation>
            É um tipo de registro que engloba todas as movimentações financeiras
            realizadas dentro de uma organização. Nesse controle, é realizado
            anotações das entradas e saídas de dinheiro. O objetivo deste
            registro é justamente obter as informações necessárias para saber
            qual o momento certo de iniciar uma ação.
          </DescriptionInformation>
          <TitleInformation>Vantagens</TitleInformation>
          <DescriptionInformation>
            <ul>
      ...
      <ContainerSpace>
        <Accordion
          ...
          contentAccordion={
            <>
              <DescriptionInformation>
                É um dos processos de maior importância na gestão financeira de
                uma empresa. Sem o domínio dessa variável, fica difícil saber o
                que é lucro e o que é apenas faturamento. Sem contar que não
                seráo possível saber se o dinheiro que existe em caixa está
                disponível ou já tem compromisso com alguma obrigação da
                organização.
              </DescriptionInformation>
              <br />
              ...
              <DescriptionInformation>
                <ul>
                  <li>Contas à pagar: como água, luz e internet e aluguel;</li>
                  <li>Contas à receber: representados pelas contas a prazo.</li>
                </ul>
              </DescriptionInformation>
              <br />
              <TitleInformation>Vantagens:</TitleInformation>
              <DescriptionInformation>
                <ul>
                  <li>É importantíssimo para a saúde financeira da empresa;</li>
          ...
          contentAccordion={
            <>
              <DescriptionInformation>
                ...
                empresa, em determinado período de tempo. O seu controle envolve
                identificar e documentar todas as saídas e entradas de dinheiro.
                Como resultado, é possível entender se o negócio estár operando
            ...
            <>
              ...
              <DescriptionInformation>
                <ul>
                  ...
                  <li>
                    Gerar informações sobre os saldos bancários existentes para
                    tomada de decisão.
                  </li>
                </ul>
              </DescriptionInformation>
        ...
        <Accordion
          ...
          contentAccordion={
            <>
              ...
              <DescriptionInformation>
                São recursos disponibilizados por instituições financeiras para
                pessoas físicas ou empresas, seja na forma empréstimos ou
                financiamentos.
              </DescriptionInformation>
              <br />
              <TitleInformation>
              ...
              <DescriptionInformation>
                ...
                operacionais e de fluxos de caixa, como pagamento de salários,
                fornecedores, aluguel e outras contas. A solicitação de linhas
                de crédito para capital de giro não exige uma finalidade
                específica, geralmente, esses valores são oferecidos a juros
                baixos e com prazos mais longos.
              </DescriptionInformation>
              <br />
              <TitleInformation>
              ...
              <DescriptionInformation>
                <ul>
                  <li>
                    ...
                    Nacional de Desenvolvimento Econômico e Social – BNDES. Ele
                    conta com várias linhas de financiamento com condições
                    diversas e que devem ser conferidas.
                  </li>
                  <li>
                    Cartão BNDES: Permite ao empreendedor adquirir bens móveis
                    para o negócio, com pagamento em até 48 vezes e taxa de
                    juros baixa.
                  </li>
                  <li>
                    Microcrédito: A Caixa Econômica Federal oferece uma linha de
                    crédito que libera determinado valor após a análise do
                    crédito e da capacidade de pagamento da empresa em questão.
                    Por meio do microcrédito, cada empreendedor pode captar até
                    20.000 reais.
                  </li>
                  <li>
                    Linhas de crédito do Santander: Possui opções de linhas de
                    empréstimo para pequenas e médias empresas de acordo com os
      ...
      <DefaultInformation>
        ...
        <ContainerText>
          ...
          <DescriptionInformation>
            O banco ou instituição financeira fazem a análise para garantir que
            você realmente terá condições de pagar o crédito pedido. O que
          ...
          <DescriptionInformation>
            O primeiro objetivo da avaliação é garantir que o banco vai receber
            o dinheiro liberado. Outro ponto é saber o número de dívidas que
            você tem com ele. Dessa forma, você não corre o risco de comprometer
            toda sua renda.
          </DescriptionInformation>
        </ContainerText>
      </DefaultInformation>
      ...
      <DefaultInformation>
        ...
        <ContainerText>
          <DescriptionInformation>
            ...
            financeira saber como é seu relacionamento com o mercado de crédito.
            Para isso, é possível que eles consultem seu Score de Crédito, a
            pontuação que demonstra a sua saúde financeira;
          </DescriptionInformation>
          <DescriptionInformation>
            Renda: O próximo passo é consultar sua renda. Isso serve para saber
            se a parcela cabe no seu bolso ou o limite do cartão está adequado
            para o salário. Geralmente, o valor de uma despesa dessa não pode
            ultrapassar 30% do seu salário, afinal você tem outras contas.
          </DescriptionInformation>
          <DescriptionInformation>
      ...
      <ContainerSpace>
        ...
        <DescriptionInformation>
          ...
          especialmente, é comum que os empresários assumam a gestão financeira
          da empresa, mas nem sempre estão preparados ecapacitados para essa
          responsabilidade.
        </DescriptionInformation>
        <DescriptionInformation>
        ...
        <Accordion
          ...
          contentAccordion={
            <>
              <DescriptionInformation>
                Com uma carga horária enxuta, de três horas, o curso é dividido
                em:
              </DescriptionInformation>
              <br />
              <DescriptionInformation>
              ...
              <DescriptionInformation>
                ...
                finanças e organizar a rotina, desde os conceitos básicos até o
                monitoramento do fluxo de caixa e controle de estoque. O melhor
                é que o curso é totalmente gratuito e dá direito ao certificado
                digital, e pode ser concluído em até 15 dias.
              </DescriptionInformation>
              <br />
        ...
        <Accordion
          ...
          contentAccordion={
            <>
              ...
              <br />
              <DescriptionInformation>
                Seu nome é Como gerenciar as finanças da sua empresa, com carga
                horária de duas horas e prazo de conclusão de 15 dias.
              </DescriptionInformation>
              <br />
              <DescriptionInformation>
        ...
        <Accordion
          ...
          contentAccordion={
            <>
              <DescriptionInformation>
                É uma ótima oportunidade de aprender ciências contábeis de forma
                descomplicada e de graça. Ele é indicado para empreendedores,
                investidores e analistas, trazendo os conceitos básicos da
                contabilidade e sua aplicação nas empresas.
              </DescriptionInformation>
              <br />
              <DescriptionInformation>
        ...
        <Accordion
          ...
          contentAccordion={
            <>
              <DescriptionInformation>
                Seu catálogo é composto por centenas de orientações de todos os
                níveis para os usuários, inclusive na área de finanças. Com um
                conteúdo em vídeo e apenas 5 horas de estudo, gestores e
                empreendedores interessados em um curso de finanças empresariais
                rápido e conciso podem acessar o material gratuitamente.
              </DescriptionInformation>
              <br />
              <DescriptionInformation>
                Conteúdo do curso:
      ...
      <DefaultInformation>
        <ContainerText>
          ...
          <DescriptionInformation>
            Denomina-se “tributação” a aplicação de tributos pelo governo, seja
            sobre a renda, sobre o consumo ou sobre o patrimônio das pessoas
          ...
          <DescriptionInformation>
            <ul>
              ...
              <br />
              <li>
                Lucro Presumido: O Lucro Presumido é um regime tributário em que
                a empresa faz a apuração simplificada do Imposto de Renda de
                Pessoa Jurídica (IRPJ) e da Contribuição Social sobre o Lucro
                Líquido (CSLL). A Receita Federal presume que uma determinada
                porcentagem do faturamento é o lucro.
              </li>
              <br />
              <li>
                Simples Nacional: É um regime tributário exclusivo para micro e
                pequenas empresas, e surgiu com o objetivo de reduzir a
      ...
      <DefaultInformation>
        ...
        <ContainerText>
          ...
          <DescriptionInformation>
            <ul>
              <li>
                SIMPLES NACIONAL: Uma empresa Simples Nacional tem contabilidade
                ...
                processos de licitação e na exportação de produtos. Apenas
                Microempresas e Empresas de Pequeno Porte podem optar pelo
                Simples Nacional:
              </li>
              <br />
              <li>
                Microempresa (ME): até 360 mil reais de faturamento nos últimos
                12 meses.
              </li>
              <br />
              <li>
                ...
                condições que precisam ser atendidas para que uma empresa possa
                ser enquadrada neste regime tributário.
              </li>
            </ul>
          </DescriptionInformation>
        </ContainerText>
      ...
      <DefaultInformation>
        <ContainerText>
          <TitleInformation>SOLICITAÇÃO DO SIMPLES NACIONAL:</TitleInformation>
          <DescriptionInformation>
      ...
      <ContainerSpace>
        ...
        <Accordion
          ...
          contentAccordion={
            <>
              ...
              <DescriptionInformation>
                Receita: Será analisada a receita recorrente e o valor do lucro
                líquido para saber se você consegue arcar com as prestações;
              </DescriptionInformation>
              <DescriptionInformation>
        ...
        <Accordion
          ...
          contentAccordion={
            <>
              <DescriptionInformation>
                Controle de caixa é o registro das entradas e saídas diárias no
                caixa da empresa com objetivo de gerar um histórico
